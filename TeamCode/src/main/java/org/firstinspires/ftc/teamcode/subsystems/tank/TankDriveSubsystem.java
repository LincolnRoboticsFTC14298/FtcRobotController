...
import org.firstinspires.ftc.teamcode.subsystems.tank.SampleTankDrive;

/**
 * A subsystem that uses the {@link SampleTankDrive} class.
 * This periodically calls {@link SampleTankDrive#update()} which runs the internal
...
public class TankDriveSubsystem extends SubsystemBase {
    ...
    public TankDriveSubsystem(SampleTankDrive drive, boolean isFieldCentric) {
        this.drive = drive;
