...
public class DuckDeterminationPipeline extends OpenCvPipeline
{
    ...
    /*
     * Some color constants, I need to change it to yellow of the rubber duck
     */
    ...
    public Mat processFrame(Mat input)
    {
        ...
        Log.d("avg1", "Value: " + avg1);
        Log.d("avg2", "Value: " + avg2);
        Log.d("avg3", "Value: " + avg3);
